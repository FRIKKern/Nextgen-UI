...
interface IInnerContainerProps extends React.HTMLAttributes<HTMLElement> {
...
const InnerContainer: React.FC<IInnerContainerProps> = ({ children, className = '', declarativeOnly = false, as: Component = 'div', disableGroup = false, disableFullWidth = false, disableContainer = false, ...rest }) => {
    let baseClasses = '';
    if (!declarativeOnly) {
